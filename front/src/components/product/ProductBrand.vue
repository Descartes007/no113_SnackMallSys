  ...
  <div class="product-brand">
    <el-card class="product-hd" shadow="never">
      ...
      <el-form :model="productBrandForm" ref="productBrandForm" inline class="query-form">
        <el-form-item label="输入搜索：" prop="key">
          <el-input v-model="productBrandForm.key" @keyup.enter.native="queryProductBrand" clearable placeholder="产品名称/关键字"></el-input>
        </el-form-item>
      </el-form>
    </el-card>
    <el-card class="product-box" shadow="never">
      ...
      <el-table :data="productBrand" class="brand-table" height="425"  border style="width: 100%">
        ...
        <el-table-column prop="brandName" label="产品名称" width="350"></el-table-column>
        <el-table-column prop="brandDescribe" label="产品描述" width="600"></el-table-column>
    ...
    <el-dialog title="编辑商品品牌信息" class="chang-product" :close-on-click-modal="false" :visible.sync="dialogFormVisible" center>
      <el-form class="info-form" inline :rules="alterRules" :model="alterForm" ref='changeFrom'>
        <el-form-item label="产品名称：" prop="brandName" style="width: 100%">
          <el-input size="small" v-model="alterForm.brandName" placeholder="产品名称"></el-input>
        </el-form-item>
        <el-form-item label="产品描述：" prop="brandDescribe" style="width: 100%">
          <el-input size="small" type="textarea" autosize v-model="alterForm.brandDescribe" placeholder="产品描述"></el-input>
        </el-form-item>
      </el-form>
      ...
      deleteBrand(index, rows){
        ...
        this.$http.post('/product/existsBrand?productBrand='+name).then((rep)=>{
          if(rep.data.code===200){
            if(rep.data.data){
              this.$alert('品牌('+name+')\t下存在零食，无法删除', '警告', {confirmButtonText: '确定', type:"warning"});
            }else{
