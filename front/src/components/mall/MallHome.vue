        ...
        <el-menu-item index="1" style="width: 50%">
          ...
          >
            <el-select
              ...
              slot="prepend"
              placeholder="请选择"
              style="width: 120px; user-select: none"
            >
            ...
            <el-button
              slot="append"
              icon="el-icon-search"
              @click="queryProduct(queryProductInfo)"
            ></el-button>
          </el-input>
        </el-menu-item>
        <el-submenu index="2" style="width: 10%">
        ...
        <h2 class="new-product-title" style="width: 98.5%">
          ...
          <div style="position: absolute; top: 6px; right: 16px">
            <el-button
              ...
              :disabled="butLFlag"
              size="mini"
              style="padding: 5px 12px; margin: 0"
              @click="newLeft()"
            ></el-button>
            <el-button
